    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        >
          ...
          <p
            className={`text-md md:text-lg font-body max-w-2xl mx-auto uppercase tracking-widest opacity-70 transition-colors duration-500`}
            ...
            {prizeTiers.map((tier) => (
              ...
              >
                ...
                <div className="p-8 relative z-10 flex flex-col h-full">
                  ...
                  <p
                    className={`font-body text-sm mb-8 line-clamp-2 h-10 transition-colors duration-500`}
                    style={{ color: activeTheme.textSecondary }}
                  >
                    {tier.description}
                  </p>
                  ...
                  <div
                    className="h-[2px] w-full mt-auto mb-6"
                    style={{
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    {tier.stats.map((stat, idx) => (
                      ...
                      >
                        <span
                          className={`text-[10px] uppercase font-bold mb-1 tracking-wider transition-colors duration-500`}
                          style={{ color: activeTheme.textSecondary }}
                        >
                          {stat.label}
                        </span>
                        <span
                          className={`text-lg font-heading tracking-wide transition-colors duration-500`}
