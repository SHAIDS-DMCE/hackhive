  ...
  const sponsorTiers = [
    {
      ...
      description: 'Leading the way in global tech innovation and software solutions.',
    ...
    },
    {
      ...
      role: 'Title Sponsor',
      size: 'large',
      description: 'Pioneering research and development for the next generation of startups.',
    ...
    },
    {
      ...
      size: 'small',
      description: 'Providing cloud infrastructure and digital transformation services.',
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                  <div className="p-8 md:p-12">
                    ...
                    <div className="h-[2px] w-full mb-8" style={{ background: '#e62429', opacity: 0.3 }}></div>

                    <div className="grid md:grid-cols-2 gap-8">
                      <div>
                        <h4 className="font-heading text-xl mb-4 uppercase tracking-wider" style={{ color: '#e62429' }}>
                          Perks & Branding
                        </h4>
                      ...
                      <div className="p-6 rounded-xl border transition-colors duration-500"
                        ...
                        <h4 className="font-heading text-xl mb-4 uppercase tracking-wider" style={{ color: theme === 'dark' ? '#fff' : '#000' }}>
                          Company Profile
                        </h4>
